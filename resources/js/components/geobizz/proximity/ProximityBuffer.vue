                ...
                <v-container style="height: auto" fluid>
                    <v-row no-gutters>
                        ...
                        <v-col cols="12" md="12">
                            <v-row no-gutters>
                                <v-col cols="12" md="6">
                                <v-checkbox small style="margin-top: -2px"  v-model="BufferOnOff" label="Buffer" color="green darken-4" value="BufferOnOff" hide-details @click="setProximityBuffer(BufferOnOff)"></v-checkbox>
                                </v-col>
                    ...
                    <v-row >
                        <v-col cols="12" md="12" v-if="this.lat && this.lng">
                            ...
                            <!-- <v-text-field style="height: 50px;" suffix="km"  class="teboxr" :rules="[() => !!radius || 'radius is rquired']" outlined solo dense color="green darken-4" clearable  v-model="radius"  label="Radius" required></v-text-field> -->
                            <v-select class="teboxr" outlined solo dense color="green darken-4" clearable  v-model="mainCategory" :items="mainCategoryList" @change="setSubCategory(mainCategory)" label="Select main category" required></v-select>
                            <v-select class="teboxr" outlined solo dense color="green darken-4" clearable  v-model="subCategory" :items="subCategoryList" label="Select sub category" required></v-select>
                        </v-col>

                        <v-col cols="12" md="12">
                            <v-row no-gutters>
                                <v-col cols="12" md="6">
                                    <v-text-field class="teboxr" outlined solo dense color="green darken-4" clearable  v-model="lat"  label="Latitude" required></v-text-field>
                                </v-col>
                                <v-col cols="12" md="6">
                                    <v-text-field class="teboxr" outlined solo dense color="green darken-4" clearable  v-model="lng"  label="Longitude" required></v-text-field>
                                </v-col>
                            </v-row>
                    ...
                    <v-row>
                                <v-col cols="12" md="6">
                                    <v-btn left dark  x-small style="text-decoration:none !important;" color="green darken-4" @click="runProximityAnalysis" :disabled="isNaN(parseFloat(lat)) || isNaN(parseFloat(lng)) || isNaN(radius) || !subCategory || subCategory === '' ">
                                        <v-icon left small>mdi-clock-start</v-icon>Start
                                    </v-btn>
                                </v-col>
                                <v-col cols="12" md="6">
                                    <v-btn left dark  x-small style="text-decoration:none !important;" :disabled="isNaN(parseFloat(lat)) || isNaN(parseFloat(lng)) || isNaN(radius) " color="error" @click="clearProximityAnalysis">
                                        ...
                                        <v-list-item-content>
                                            <v-list-item-title>
                                                <xlsx-workbook >
                                                    ...
                                                    />
                                                    <xlsx-download>
                                                        <v-btn outlined x-small>Download Excel</v-btn>
                                                    </xlsx-download>
                                                </xlsx-workbook>
                                            </v-list-item-title>
                                        </v-list-item-content>
