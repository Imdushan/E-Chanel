    ...
    <div >
        <v-tabs v-model="tabLayer">
            ...
            <v-tabs-items v-model="tabLayer">
                ...
                <!--      Load Dataset          -->
                <v-tab-item>
                    <v-card style="margin: 5px" flat height="30">
                        <!--                    <fieldset>-->
...
export default {
    ...
    watch:{
        ...
        mapContextAction(action){
            if (action.drawerID === 'mapToolBar' && action.tabID === 'map_data_polygon'){
    ...
    methods:{
        ...
        loadLayerData(){
            axios.post('/api/dataOperator/mapDataLayers/geojson/get',{type:'polygon'},store.state.httpheader.header).then(response => {
        ...
        startDrawing(){
            ...
            this.startDraw = true;
            store.commit('addToMapContextMenu', {title: 'Polygon Layer', id: 'map_data_polygon', action: {type: 'navigation', drawer: 'right', drawerID: 'mapToolBar', tabID: 'map_data_polygon', tabNo: 0}});
        },
        ...
        clearDrawing(){
            ...
            store.commit('removeFromMapContextMenu', {id:'map_data_polygon'});
        },
        ...
        sendJsonToBackEnd(json){
            ...
            formData.append("layerType", 'polygon');
            ...
            if (layer && !exists) {
                $.getJSON(getLayerDetails.url, function (data) {
                    ...
                    $.each(features, function (key, val) {
                        console.log('akjhgdjhasgfjh',val);
                        if (val.h.fillColor) {
                            //-----------------styling the feature-------------------------------
                ...
                store.commit('addToMapContextMenu', {title: 'Polygon Layer', id: 'map_data_polygon', action: {type: 'navigation', drawer: 'right', drawerID: 'mapToolBar', tabID: 'map_data_polygon', tabNo: 1}});
            }
        },
