...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 30, 2022 at 01:53 AM
...
CREATE TABLE IF NOT EXISTS `driver` (
  ...
  `licean_no` varchar(255) DEFAULT NULL,
  `age` varchar(255) DEFAULT NULL,
  `vehicle_no` varchar(255) DEFAULT NULL,
  `vehicle_type` varchar(255) DEFAULT NULL,
  `max_passengers` varchar(255) DEFAULT NULL,
  `email` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `e_channel` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `doctor_id` varchar(255) DEFAULT NULL,
  `patient_id` varchar(255) DEFAULT NULL,
  `chanel_type` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `transport_request` (
  ...
  `Chanel_id` varchar(255) DEFAULT NULL,
  `Status` varchar(255) DEFAULT NULL,
  `Feedback_driver` varchar(255) DEFAULT NULL,
  `Feedback_passenger` varchar(255) DEFAULT NULL,
  `picked_lat` varchar(255) DEFAULT NULL,
  `picked_lng` varchar(255) DEFAULT NULL,
  `dropped_lat` varchar(255) DEFAULT NULL,
  `dropped_lng` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
